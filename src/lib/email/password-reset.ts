...
<body style="margin:0;padding:0;background:#f1f5f9;font-family:Arial,Helvetica,sans-serif;">
  <div style="max-width:600px;margin:0 auto;padding:24px;">
    ...
    <div style="background:#ffffff;padding:24px;">
      ...
      <p style="margin:0 0 16px 0;font-size:18px;font-weight:700;color:#0c1e3c;letter-spacing:1px;">
        ${escapeHtml(data.tempPassword)}
      </p>
      <p style="margin:0 0 16px 0;font-size:14px;color:#334155;">
        Ingresá con esta contraseña y cambiala cuanto antes.
      </p>
      <a href="${APP_URL}/login" style="display:inline-block;font-size:14px;font-weight:600;color:#ffffff;background:#0c1e3c;padding:10px 18px;border-radius:6px;text-decoration:none;">Iniciar sesión</a>
    </div>
